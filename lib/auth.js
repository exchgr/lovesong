...
module.exports = {
	...
	'facebook': {
		'start': [
			passport.authenticate('facebook', {scope: ['user_location', 'user_relationships', 'friends_relationships', 'user_relationship_details', 'friends_relationship_details', 'friends_location']})
		],
		'end': [
